<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="formRegister.aspx.cs" Inherits="WebQuanLySanPham.formRegister" %>
...
<body>
    <form id="form__register" runat="server">
                        ...
                        <div class="col l-o-4 l-4 c-12">
                            <div class="content">
                                <div class="form__login">
                                    <div class="title">
                                        <h1 class=""> Đăng Ký</h1>
                                        <h2 class="link__form--register"> Đăng nhập ngay <a href="#">tại đây</a></h2>
                                    </div>     
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <asp:TextBox ID="txt_userPasswordConfirm" runat="server" class="input__username form-control" name="user" placeholder="Vui lòng nhập lại mật khẩu ..."></asp:TextBox>
                                        <span class="errorMessage__3"></span>
                                    </div>

                                    <asp:Button ID="btn__Login" class="btn__Login" runat="server" Text="ĐĂNG KÝ"/>
    ...
    <script src="Assets/client/js/validateRegister.js"></script>
</body>
</html>
